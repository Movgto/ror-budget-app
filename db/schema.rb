...
ActiveRecord::Schema[7.1].define(version: 2023_11_28_202920) do
  ...
  create_table "category_operations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id", "operation_id"], name: "index_category_operations_on_category_id_and_operation_id", unique: true
